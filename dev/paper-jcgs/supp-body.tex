...
The code archive contains the source of the \texttt{jmjax} package at
release 0.3.0 (DOI 10.5281/zenodo.22950084), whose \texttt{dev/} folder
holds the scripts below, and a \texttt{results/} folder with two result
files written outside the repository. Paths are relative to the package
root; the archive's README gives setup and run instructions.

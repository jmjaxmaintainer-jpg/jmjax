...
\citep{phan2019}. brms and rstanarm generate the non-centered
...
centering \citep{gelfand1995} removes it by sampling the centered effects,
at the price of the funnel that non-centering was introduced to avoid, and
...
device for analyzing Gibbs samplers, and \citet{browne2009} name the

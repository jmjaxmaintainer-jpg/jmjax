...
*Contributor notes: how the R front end and the Python backend divide the
work, and how the tests are organized. Moved here from `README.md` for
0.3.0; parts of the "Current scope and limits" list describe earlier
states, and `?jm_fit` is authoritative.*
